...
And to make the intl_nodelist for the intl_edgelist we can just filter down the full sna_edgelist we made in 01_full-network-construction. This nodelist is what we would want to use for any regression anaylses on international collaboration patterns. 
...
If we wanted to make dynamic nodelists that go year-by-year then we can use pull from our existing nodelist that has years. This will be taken from the year-by-year .Rmd files. 
