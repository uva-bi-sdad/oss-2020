...
network_stats <- data.frame(year="2008-12")                                          
...
network_stats$triads <- triad_census(login_network)[1]
...
nodelist$est_btw_cent <- estimate_betweenness(login_network, cutoff = 10) # using 3 ~ 5hrs; 5 ~ 6.2hrs; 10 ~ 8.8hrs; 15 ~ 10.5hrs
nodelist$est_close_cent <- estimate_closeness(login_network, cutoff = 10) # using 3 ~ 6.3hrs; 5 ~ 6.8hrs; 10 ~ 10.1hrs; 15 ~ 12.2hrs
...
saveRDS(network_stats, "global_netstats_2008-12.rds")  
saveRDS(decomposition_stats, "decomposition_stats_2008-12.rds") 
saveRDS(nodelist, "nodelist_2008-12.rds")  
saveRDS(time_log, "timelog_2008-12.rds")
```
...
ptm <- proc.time()
#igraph::estimate_closeness(login_network, cutoff = 2)[1:100]
#igraph::estimate_closeness(login_network, cutoff = 3)[1:100]
#igraph::estimate_closeness(login_network, cutoff = 5)[1:100]
#igraph::estimate_closeness(login_network, cutoff = 10)[1:100]
igraph::estimate_closeness(login_network, cutoff = 15)[1:100]
proc.time() - ptm

# 2 
  user  system elapsed 
  0.330   0.035   2.137
2.195 / 100 * 717500 / 60 / 60
# 3
user  system elapsed 
  0.634   0.025   2.519
3.161 / 100 * 717500 / 60 / 60
# 5 
user  system elapsed 
  1.674   0.032   3.131
3.419 / 100 * 717500 / 60 / 60
#10 
user  system elapsed 
  3.169   0.035   4.418 
5.112 / 100 * 717500 / 60 / 60
#15
user  system elapsed 
  3.970   0.043   5.313   
6.143  / 100 * 717500 / 60 / 60
```
