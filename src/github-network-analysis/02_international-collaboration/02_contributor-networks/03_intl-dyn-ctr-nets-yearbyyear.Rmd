...
saveRDS(network_stats, "global_netstats_yxy_2017.rds")  
saveRDS(decomposition_stats, "decomposition_stats_yxy_2017.rds") 
saveRDS(nodelist, "nodelist_yxy_2017.rds")  
saveRDS(time_log, "timelog_yxy_2017.rds")
```
