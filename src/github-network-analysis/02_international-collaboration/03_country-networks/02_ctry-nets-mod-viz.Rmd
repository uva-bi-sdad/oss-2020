...
intl_regular_network <- graph_from_data_frame(d=sna_intl_ctry_edgelist_full, 
...
intl_ctry_network_noloops <- simplify(graph_from_data_frame(d=sna_intl_ctry_edgelist_full, 
                              vertices=sna_intl_ctry_nodelist, directed=FALSE), 
                              edge.attr.comb = igraph_opt("edge.attr.comb"),
                              remove.loops = TRUE) 
...
# add the community membership to the nodelist 
sna_intl_ctry_nodelist_noloops <- sna_intl_ctry_nodelist
