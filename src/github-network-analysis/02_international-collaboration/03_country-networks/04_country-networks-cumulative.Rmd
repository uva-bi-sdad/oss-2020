...
# create cumulative networks 
ctry_edgelist_08 <- sna_intl_ctry_edgelist %>% 
  filter(year == "2008") %>% 
  select(country1, country2, repo_wts) %>% 
  mutate(weight = repo_wts) %>% select(-repo_wts)
  
ctry_edgelist_0809 <- sna_intl_ctry_edgelist %>% 
  filter(year == "2008" | year == "2009") %>% 
  select(country1, country2, repo_wts) %>% 
  mutate(weight = repo_wts) %>% select(-repo_wts)

ctry_edgelist_0810 <- sna_intl_ctry_edgelist %>% 
  filter(year == "2008" | year == "2009" | year == "2010") %>% 
  select(country1, country2, repo_wts) %>% 
  mutate(weight = repo_wts) %>% select(-repo_wts)

ctry_edgelist_0811 <- sna_intl_ctry_edgelist %>% 
  filter(year == "2008" | year == "2009" | year == "2010" | year == "2011") %>% 
  select(country1, country2, repo_wts) %>% 
  mutate(weight = repo_wts) %>% select(-repo_wts)
  
ctry_edgelist_0812 <- sna_intl_ctry_edgelist %>% 
  filter(year == "2008" | year == "2009" | year == "2010" | year == "2011" | year == "2012") %>% 
  select(country1, country2, repo_wts) %>% 
  mutate(weight = repo_wts) %>% select(-repo_wts)
  
ctry_edgelist_0813 <- sna_intl_ctry_edgelist %>% 
  filter(year == "2008" | year == "2009" | year == "2010" | 
         year == "2011" | year == "2012" | year == "2013") %>% 
  select(country1, country2, repo_wts) %>% 
  mutate(weight = repo_wts) %>% select(-repo_wts)

ctry_edgelist_0814 <- sna_intl_ctry_edgelist %>% 
  filter(year == "2008" | year == "2009" | year == "2010" | 
         year == "2011" | year == "2012" | year == "2013" | year == "2014") %>% 
  select(country1, country2, repo_wts) %>% 
  mutate(weight = repo_wts) %>% select(-repo_wts)  
  
ctry_edgelist_0815 <- sna_intl_ctry_edgelist %>% 
  filter(year == "2008" | year == "2009" | year == "2010" | 
         year == "2011" | year == "2012" | year == "2013" | year == "2014" | year == "2015") %>% 
  select(country1, country2, repo_wts) %>% 
  mutate(weight = repo_wts) %>% select(-repo_wts)  
  
ctry_edgelist_0816 <- sna_intl_ctry_edgelist %>% 
  filter(year == "2008" | year == "2009" | year == "2010" | year == "2011" | year == "2012" | 
         year == "2013" | year == "2014" | year == "2015" | year == "2016") %>% 
  select(country1, country2, repo_wts) %>% 
  mutate(weight = repo_wts) %>% select(-repo_wts)  
  
ctry_edgelist_0817 <- sna_intl_ctry_edgelist %>% 
  filter(year == "2008" | year == "2009" | year == "2010" | year == "2011" | year == "2012" | 
         year == "2013" | year == "2014" | year == "2015" | year == "2016" | year == "2017") %>% 
  select(country1, country2, repo_wts) %>% 
  mutate(weight = repo_wts) %>% select(-repo_wts)
  
ctry_edgelist_0818 <- sna_intl_ctry_edgelist %>% 
  filter(year == "2008" | year == "2009" | year == "2010" | year == "2011" | year == "2012" | 
...
# update edgelist 
ctry_edgelist <- ctry_edgelist_0818

# convert edgelists to networks 
login_network <- simplify(graph.data.frame(ctry_edgelist, directed = FALSE))
...
saveRDS(network_stats, "global_netstats_2008-18.rds")  
saveRDS(decomposition_stats, "decomposition_stats_2008-18.rds") 
saveRDS(nodelist, "nodelist_2008-18.rds")  
saveRDS(time_log, "timelog_2008-18.rds")

```

```{r}
mean(degree(login_network))
