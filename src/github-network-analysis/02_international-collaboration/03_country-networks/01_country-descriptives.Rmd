...
intl_stats %>% 
  ...
  scale_y_continuous(breaks = c(0, 250000, 500000, 750000, 1000000, 1250000, 1500000, 1750000), 
...
intl_stats %>% 
  ...
  scale_y_continuous(breaks = c(0, 20000000, 40000000, 60000000, 80000000, 100000000, 120000000), 
