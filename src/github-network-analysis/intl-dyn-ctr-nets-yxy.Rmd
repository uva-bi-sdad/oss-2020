...
network_stats$mod_scaled <- modularity(louvain) / gorder(login_network)
network_stats$mod_logged <- modularity(louvain) / log(gorder(login_network))
...
is.connected(login_network)

comps <- decompose.graph(login_network)

table(sapply(comps, vcount))
table(sapply(comps, vcount))[1] / gorder(login_network)
table(sapply(comps, vcount))[8]
3976 / gorder(login_network)

table(sapply(cliques(login_network), length))

table(sapply(cliques(login_network), length) == 4) #12:08 - 
table(sapply(cliques(login_network), length) == 5)
table(sapply(cliques(login_network), length) == 6)
