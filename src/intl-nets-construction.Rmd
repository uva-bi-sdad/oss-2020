...
oss_data <- dbGetQuery(conn, "SELECT login, created_at, country_code, location 
...
users_gh_cc %>% dplyr::filter(grepl(",", country_code))
```
...
## Creating a Nodelist with Multiple Country Code Labels ##########################################################################################
...
## Creating Dynamic Networks (Not Done Yet) ##########################################################################################
