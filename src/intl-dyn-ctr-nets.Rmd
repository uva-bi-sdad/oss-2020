---
title: "International Contributor Networks"
...
*Code for Pulling OSS Bipartite Networks Year-by-Year.* We will need to come back and program a function to loop this later, but I actually just used these snippets for the year-by-year datasets. 
...
*Code for Pulling OSS Bipartite Networks Cumulatively.* We will need to come back and program a function to loop this later, but I used these snippets to pull data from year ranges to aggregate the cumulative datasets. 
...
# density, diameter, mean distance and transitivity
...
network_stats$modularity <- modularity(louvain)
net_comm_det <- data.frame(event="net_comm_det", time=now("EST"))
time_log <- rbind(time_log, net_comm_det); rm(net_comm_det, louvain)
saveRDS(network_stats, "global_netstats_2017.rds")                               
saveRDS(time_log, "time_log_2017.rds")              
```

Once we got those statistics calculated for each year, we aggregated them together using this code chunk. 
...
global_netstats_yxy <- rbind(global_netstats_2008, global_netstats_2009, global_netstats_2010, global_netstats_2011, global_netstats_2012, global_netstats_2013, 
                         global_netstats_2014, global_netstats_2015, global_netstats_2016, global_netstats_2017, global_netstats_2018)

saveRDS(global_netstats_yxy, "global_netstats_yxy.rds")

rm(global_netstats_2008, global_netstats_2009, global_netstats_2010, global_netstats_2011, global_netstats_2012, 
   global_netstats_2013, global_netstats_2014, global_netstats_2015, global_netstats_2016, global_netstats_2017, global_netstats_2018)

```

We did the same once we had the cumulative network statistics as well. 
...
setwd("~/2008-09")
global_netstats_200809 <- readRDS("global_netstats_2008_09.rds")
setwd("~/2008-10")
global_netstats_200810 <- readRDS("global_netstats_2008_10.rds")
setwd("~/2008-11")
global_netstats_200811 <- readRDS("global_netstats_2008_11.rds")
setwd("~/2008-12")
global_netstats_200812 <- readRDS("global_netstats_2008_12.rds")
setwd("~/2008-13")
global_netstats_200813 <- readRDS("global_netstats_2008_13.rds")
setwd("~/2008-14")
global_netstats_200814 <- readRDS("global_netstats_2008_14.rds")
setwd("~/2008-15")
global_netstats_200815 <- readRDS("global_netstats_2008_15.rds")
setwd("~/2008-16")
global_netstats_200816 <- readRDS("global_netstats_2008_16.rds")
setwd("~/2008-17")
global_netstats_200817 <- readRDS("global_netstats_2008_17.rds")
setwd("~/2008-18")
global_netstats_200818 <- readRDS("global_netstats_2008_18.rds")
...
global_netstats_cum <- as_tibble(c("2008", "2008-09", "2008-10", "2008-11", "2008-12", "2008-13", "2008-14", "2008-15", "2008-16", "2008-17", "2008-18")) %>% 
  bind_cols(global_netstats_cum) %>% select(-year) %>% rename(year = value)
...
## Calculating Node Level Network Statistics 

*Year-by-Year Node Level Statistics.* We used this code to construct node-level statistics for the year-by-year networks, including the degree centrality measure (both weight and unweighted), the k-core measure, the Louvain cluster grouping, and the component grouping.

```{r individualized network stats}
rm(list = ls())
setwd("~/2018")
login_network <- read_rds("login_network.rds")
time_log <- read_rds("time_log_2018.rds")
...
setwd("~/2018")
saveRDS(nodelist, "nodelist_2018.rds")                               
saveRDS(time_log, "time_log_2018.rds")
```
...
*Cumulative Node Level Statistics.* We used this code to construct node-level statistics for the cumulative networks, including the degree centrality measure (both weight and unweighted), the k-core measure, the Louvain cluster grouping, and the component grouping.

```{r individualized network stats cum}
rm(list = ls())
setwd("~/2008-18")
login_network <- read_rds("login_network.rds")
time_log <- read_rds("time_log_2008_18.rds")
...
setwd("~/2008-18")
saveRDS(nodelist, "nodelist_2008_18.rds")                               
saveRDS(time_log, "time_log_2008_18.rds")
```
