...
write_csv(usgov_azindex, "/sfs/qumulo/qhome/kb7hp/oss-2020/data/usgov_azindex.csv", row.names = FALSE)
...
test_edgelist <- usgov_to_edgelist(us_gov_azindex_dedup)
test_nodelist <- usgov_to_nodelist(test_edgelist)
test_graph <- usgov_to_graph(us_gov_azindex_dedup)
