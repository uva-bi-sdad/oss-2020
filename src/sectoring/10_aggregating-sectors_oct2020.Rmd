...
positions <- c("business", "academic","houshold","government", "non-profit")
...
select_counts <- data.frame(sector = as.factor(c("business", "academic","houshold","government", "nonprofit")),
                           totals = as.numeric(c("115105", "51980", "4093", "2687", "748")),
                           percentages = as.numeric(c("65.9", "29.8", "2.3", "1.5", "0.04")))

ggplot(data=select_counts, aes(x=sector, y=totals)) +
