...
```{r}
output_df <- collab_df %>% 
  select(country, year, num_collabs, num_domestic, num_foreign, num_us, prc_domestic, prc_foreign, prc_us) %>% 
  rename(total_collabs = num_collabs, us_collabs = num_us, forgn_collabs = num_foreign, dom_collabs = num_domestic, prc_frgn = prc_foreign) 
