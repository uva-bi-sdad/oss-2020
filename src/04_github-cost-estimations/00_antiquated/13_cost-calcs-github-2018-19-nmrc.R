...
counts_by_year <- dbGetQuery(conn, "SELECT * FROM gh.cost_by_year_0919_nmrc WHERE YEAR = 2019;")
...
write_csv(counts_by_repo_top, "/sfs/qumulo/qhome/kb7hp/git/oss-2020/data/cost_estimations/repos_cost_2019_top_nmrc.csv")
write_csv(repos_by_year, "/sfs/qumulo/qhome/kb7hp/git/oss-2020/data/cost_estimations/repos_cost_2019_all_nmrc.csv")
write_csv(df, "/sfs/qumulo/qhome/kb7hp/git/oss-2020/data/cost_estimations/repos_cost_2019_summary_nmrc.csv")
