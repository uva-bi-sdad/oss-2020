...
write_csv(counts_by_repo, "/sfs/qumulo/qhome/kb7hp/git/oss-2020/data/cost_estimations/cost_by_repo_all_nmrc.csv")

counts_by_repo_top <- counts_by_repo %>%
  top_n(adds_wo_gross, n = 100)

write_csv(counts_by_repo_top, "/sfs/qumulo/qhome/kb7hp/git/oss-2020/data/cost_estimations/cost_by_repo_top_nmrc.csv")
...
write_csv(df, "/sfs/qumulo/qhome/kb7hp/git/oss-2020/data/cost_estimations/cost_by_repo_totals_nmrc.csv")
