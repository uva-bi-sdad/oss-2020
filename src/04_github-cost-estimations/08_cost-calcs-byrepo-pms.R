...
write_csv(summary_df, "cost_estimates_summary_0919_nonus.csv")
write_csv(counts_by_repo, "cost_by_repo_all_0919_nonus.csv")
write_csv(counts_by_repo_top, "cost_by_repo_top_0919_nonus.csv")
