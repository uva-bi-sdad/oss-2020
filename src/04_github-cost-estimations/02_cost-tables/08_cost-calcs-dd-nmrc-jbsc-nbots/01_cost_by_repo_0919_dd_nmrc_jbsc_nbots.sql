...
CREATE MATERIALIZED VIEW gh_cost.cost_by_repo_0919_dd_nmrc_jbsc_nbots AS (
...
GRANT ALL PRIVILEGES ON TABLE gh_cost.cost_by_repo_0919_dd_nmrc_jbsc_nbots TO ncses_oss;
