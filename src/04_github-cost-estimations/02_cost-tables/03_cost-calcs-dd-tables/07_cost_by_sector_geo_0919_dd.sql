...
CREATE MATERIALIZED VIEW gh_cost.cost_by_sector_geo_0919_dd AS (
WITH table_join AS (
...
GRANT ALL PRIVILEGES ON TABLE gh.cost_by_sector_geo_0919_dd TO ncses_oss;
