...
CREATE MATERIALIZED VIEW gh_cost.cost_by_sector_geo_0919_dd_nbots AS (
WITH table_join AS (
...
GRANT ALL PRIVILEGES ON TABLE gh.cost_by_sector_geo_0919_dd_nbots TO ncses_oss;
