...
CREATE MATERIALIZED VIEW gh_cost.cost_by_country_0919_dd_nmrc_jbsc AS (
WITH sector_join AS (
...
GRANT ALL PRIVILEGES ON TABLE gh_cost.cost_by_country_0919_dd_nmrc_jbsc TO ncses_oss;
