...
CREATE MATERIALIZED VIEW gh_cost.cost_by_sector_0919_dd_nmrc_nbots AS (
...
LEFT JOIN gh_cost.cost_logins_w_sector_info AS B
ON A.login = B.login
)
...
GRANT ALL PRIVILEGES ON TABLE gh_cost.cost_by_sector_0919_dd_nmrc_nbots TO ncses_oss;
