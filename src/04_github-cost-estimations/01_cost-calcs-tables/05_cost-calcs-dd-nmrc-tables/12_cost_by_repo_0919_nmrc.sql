...
CREATE MATERIALIZED VIEW gh.cost_by_repo_0919_nmrc AS (
...
CREATE INDEX slug_idx ON gh.cost_by_repo_0919_nmrc (slug);
GRANT ALL PRIVILEGES ON TABLE gh.cost_by_repo_0919_nmrc TO ncses_oss;
