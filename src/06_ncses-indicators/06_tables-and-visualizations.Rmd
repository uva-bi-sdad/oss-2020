...
```{r}
output_df <- collab_df %>% 
  select(country, num_collabs, num_us, num_foreign, prc_domestic, prc_foreign, prc_us) %>% 
  rename(ttl_collabs = num_collabs, us_collabs = num_us, frgn_collabs = num_foreign, prc_frgn = prc_foreign) 
