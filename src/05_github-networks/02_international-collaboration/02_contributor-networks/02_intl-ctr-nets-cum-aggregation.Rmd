...
```{r centralization_stats}

setwd("~/oss-data/intl-ctr-nets-cum")
centralization08 <- readRDS("centr_stats_2008.rds")
centralization0809 <- readRDS("centr_stats_2008-09.rds")
centralization0810 <- readRDS("centr_stats_2008-10.rds")
centralization0811 <- readRDS("centr_stats_2008-11.rds")
centralization0812 <- readRDS("centr_stats_2008-12.rds")
centralization0813 <- readRDS("centr_stats_2008-13.rds")
centralization0814 <- readRDS("centr_stats_2008-14.rds")
centralization0815 <- readRDS("centr_stats_2008-15.rds")
centralization0816 <- readRDS("centr_stats_2008-16.rds")
centralization0817 <- readRDS("centr_stats_2008-17.rds")
centralization0818 <- readRDS("centr_stats_2008-18.rds")
centralization0819 <- readRDS("centr_stats_2008-19.rds")

centralization_all <- rbind(centralization08, centralization0809, centralization0810, centralization0811, 
      centralization0812, centralization0813, centralization0814, centralization0815, centralization0816)

centralization_all

ggplot(data=centralization_all, aes(x=year, y=centr_deg, group=1)) +
  geom_line()+
  geom_point()

ggplot(data=centralization_all, aes(x=year, y=centr_btw, group=1)) +
  geom_line()+
  geom_point()
```
