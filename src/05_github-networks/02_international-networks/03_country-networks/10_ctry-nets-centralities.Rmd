...
ggplot(nodelist) +
  ...
  scale_colour_manual(values = c("Canada"="#990000", "France"="#5BC21C", "USA"="#ff7f00", "Developing"="#232D4B",
  ...
  theme_minimal() + theme(plot.title = element_text(size = 13, hjust = 0.36, vjust = 2),
  ...
  labs(title= "     Figure 3C. Comparing Centrality Measures for \n Country-Country Collaboration Networks (GitHub, 2008-2019)")
```
