...
for (pkg in c("tidyverse", "data.table", 
              "tidytable", "countrycode", "RPostgreSQL")) {library(pkg, character.only = TRUE)}
...
oss_data <- dbGetQuery(conn, "SELECT login, location, email, company FROM gh.ctrs_raw_0821")
academic_data <- dbGetQuery(conn, "SELECT login, organization, country, academic FROM gh.sna_ctr_academic_0821;")
